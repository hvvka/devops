...
import pl.edu.pwr.twwo.config.audit.AuditEventConverter;
import pl.edu.pwr.twwo.domain.PersistentAuditEvent;
...
import static pl.edu.pwr.twwo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
