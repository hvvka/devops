...
describe('Service Tests', () => {
  describe('KartaPrzedmiotu Service', () => {
    ...
    let elemDefault: IKartaPrzedmiotu;
    let expectedResult: IKartaPrzedmiotu | IKartaPrzedmiotu[] | boolean | null;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a KartaPrzedmiotu', () => {
      ...
      it('should delete a KartaPrzedmiotu', () => {
