...
describe('Service Tests', () => {
  describe('EfektKsztalcenia Service', () => {
    ...
    let elemDefault: IEfektKsztalcenia;
    let expectedResult: IEfektKsztalcenia | IEfektKsztalcenia[] | boolean | null;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a EfektKsztalcenia', () => {
      ...
      it('should delete a EfektKsztalcenia', () => {
