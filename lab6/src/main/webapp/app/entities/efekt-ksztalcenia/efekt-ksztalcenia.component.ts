...
@Component({
  ...
  templateUrl: './efekt-ksztalcenia.component.html'
})
export class EfektKsztalceniaComponent implements OnInit, OnDestroy {
  ...
  delete(efektKsztalcenia: IEfektKsztalcenia): void {
    const modalRef = this.modalService.open(EfektKsztalceniaDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.efektKsztalcenia = efektKsztalcenia;
  }
}
